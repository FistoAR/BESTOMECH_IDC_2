...
const pages = [
    ...
    { page: 12, title: "Cover Page", keywords: [ "poly v pulley"] },
    { page: 14, title: "Introduction", keywords: [ "sprocket"] },
    { page: 16, title: "Chapter 1", keywords: [] },
    { page: 18, title: "Chapter 2", keywords: ["couplings","tyre coupling"] },
    { page: 20, title: "Chapter 3", keywords: [ ] },
    { page: 22, title: "Conclusion", keywords: [] },
    { page: 24, title: "Cover Page", keywords: [] },
    { page: 26, title: "Introduction", keywords: [ "gear coupling"] },
    { page: 28, title: "Chapter 1", keywords: [ ] },
    { page: 30, title: "Chapter 2", keywords: [ "pin bush coupling"] },
    { page: 32, title: "Chapter 3", keywords: [] },
    { page: 34, title: "Conclusion", keywords: [ "roller chain flexible coupling"] },
    { page: 36, title: "Cover Page", keywords: [] },
    { page: 38, title: "Introduction", keywords: [] },
    { page: 40, title: "Chapter 1", keywords: [ "curved jaw coupling"] },
    { page: 42, title: "Chapter 2", keywords: [] },
    { page: 44, title: "Chapter 3", keywords: [] },
    { page: 46, title: "Conclusion", keywords: [ "stright jaw coupling"] },
    { page: 48, title: "Cover Page", keywords: [ ] },
    { page: 50, title: "Introduction", keywords: [ "diverter wheels"] },
    { page: 52, title: "Introduction", keywords: [ "contact us"] },
